// maps
import map from "./../../../assets/maps/overworldv4.json";
import forestMap from "./../../../assets/maps/finalForest.json";
import dungMap from "./../../../assets/maps/dungeonMap.json";
import finalBoss from "./../../../assets/maps/finalBoss.json";
...
export default function preloadAssets (scene) {
  ...
  scene.load.spritesheet('zombie7', zombie7, { frameWidth: 32, frameHeight: 32 });
  scene.load.spritesheet('zombie', zombie, { frameWidth: 32, frameHeight: 32 });
  scene.load.spritesheet('zombieKing', zombieKing, { frameWidth: 32, frameHeight: 32 });
  scene.load.spritesheet('zombieGhost', zombieGhost, { frameWidth: 32, frameHeight: 32 });
